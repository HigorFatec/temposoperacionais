...
class PontoDeApoioScreen extends StatefulWidget {
  @override
  State<PontoDeApoioScreen> createState() => PontoDeApoioScreenState();
}

class PontoDeApoioScreenState extends State<PontoDeApoioScreen> {
  ...
  String placaCarreta = '';
  String transportadora = '2.00 Chegada Ponto de Apoio';
  String tipo = 'inicio';
  // Status atual
  String? statusAtual;
  String? ordemAtual;
  ...
  Future<void> inicio_da_viagem() async {
    try {
      final snapshot = await FirebaseFirestore.instance
          .collection(isParadaExtra ? 'parada_extra_2' : 'ponto_de_apoio')
          .orderBy('codigo')
          .get();
