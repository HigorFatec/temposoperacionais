...
class DestinoScreen extends StatefulWidget {
  @override
  State<DestinoScreen> createState() => DestinoScreenState();
}

class DestinoScreenState extends State<DestinoScreen> {
  ...
  String placaCarreta = '';
  String transportadora = '6.00 Chegada Descarga';
  String tipo = 'inicio';
  // Status atual
  String? statusAtual;
  String? ordemAtual;
  ...
  Future<void> inicio_da_viagem() async {
    try {
      final snapshot = await FirebaseFirestore.instance
          .collection(isParadaExtra ? 'parada_extra_6' : 'destino')
          .orderBy('codigo')
          .get();
