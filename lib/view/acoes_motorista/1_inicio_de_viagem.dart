...
class InicioViagemScreen extends StatefulWidget {
  @override
  State<InicioViagemScreen> createState() => InicioViagemScreenState();
}

class InicioViagemScreenState extends State<InicioViagemScreen> {
  ...
  String placaCarreta = '';
  String transportadora = '1.00 Inicio de Viagem';
  String tipo = 'inicio';
  // Status atual
  String? statusAtual;
  String? ordemAtual;
  ...
  Future<void> inicio_da_viagem() async {
    try {
      final snapshot = await FirebaseFirestore.instance
          .collection(isParadaExtra ? 'parada_extra_1' : 'inicio_de_viagem')
          .orderBy('codigo')
          .get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Inicio de Viagem'),
        actions: [
          IconButton(
            onPressed: () {
              Navigator.pushReplacementNamed(context, '/inicio_de_viagem');
            },
