...
class TriagemScreen extends StatefulWidget {
  @override
  State<TriagemScreen> createState() => TriagemScreenState();
}

class TriagemScreenState extends State<TriagemScreen> {
  ...
  String placaCarreta = '';
  String transportadora = '3.00 Chegada Carregamento';
  String tipo = 'inicio';
  // Status atual
  String? statusAtual;
  String? ordemAtual;
  ...
  Future<void> inicio_da_viagem() async {
    try {
      final snapshot = await FirebaseFirestore.instance
          .collection(isParadaExtra ? 'parada_extra_3' : 'triagem')
          .orderBy('codigo')
          .get();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              Navigator.pushReplacementNamed(context, '/triagem');
            },
